...
export default function Home() {
  ...
  return (
    <>
      <Hero 
        title='Discover Cache <br />Chat GPTs First Vitual Pet'
        mintNumber='0'
        mintMax='725'
        mintPrice='0.02'
